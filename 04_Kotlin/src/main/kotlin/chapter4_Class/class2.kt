...
private open class User(private val nickName: String = "Seungsu", private val isSubscribed: Boolean = false)    // 생성자 파라미터에도 디폴트 값을 정의할 수 있음

// - 위 선언을 풀어서 쓰면 다음 코드와 같다
private open class User2 constructor(_nickName: String = "seungsu", _isSubscribed: Boolean = false) {
...
private class Secretive private constructor() {}
...
private open class View2 {
    constructor(ctx: Context) {}
    constructor(ctx: Context, attr: String)
}

private class MyButton: View2 {
...
private interface User3 {
    val nickname: String        // User3 인터페이스를 구현하는 클래스는 nickname의 값을 얻을 수 있는 방법을 제공해야 함
}

// - 아래 세 클래스는 각각 다른 방식으로 추상 프로퍼티 nickname을 구현하는 예시

private class PrivateUser(override val nickname: String): User3 {}      // - 주 생성자

private class SubscribingUser(val email: String): User3 {               // - 커스텀 게터
    override val nickname: String
        get() = email.substringBefore("@")
}

private class FacebookUser(val accountId: Int): User3 {                 // - 프로퍼티 초기화식
